...
string list_of_functions::UTF8ToANSI(string s)
{
	BSTR    bstrWide;
	char* pszAnsi;
	int     nLength;
...
string list_of_functions::ANSIToUTF8(string s)
{
	BSTR    bstrWide;
	char* pszAnsi;
	int     nLength;
...
{
	auto input_path = global_var::TEXTS_PATH/*fs::current_path()/"inputfiles"*/;
