...
public:
	...
	static void grab_dict(string path);
	static void vost_map_of_tokens_Word_and_number_of_appearances_struct_TOKEN_();
	static shared_ptr<unordered_set<int>> parse_and_lematize_one_text(string _path);
	static void out_of_predl(shared_ptr<unordered_set<int>> set_for_unique_terms, string _path);
	...
	static string get_text() { return abbreviated_text; }
private:
	//private methods
	...
	static inline string abbreviated_text;
