...
public:
	...
	static inline string LEMADR = "lemmatizer.db";
	//static inline string TEXTS_PATH = "A:\\rasp_puhl1";
	static inline string TEXTS_PATH = "\\rasp";
	static inline string SUPER_PATH = "";
	static inline int STOP_WORD = 0;
	static inline now_type DELETE_THRESHOLD = 0.065f;
	static inline now_type KOEF_FOR_COLLOC_COS_DELETE = 0.99f;
